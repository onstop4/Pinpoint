defmodule Pinpoint.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Pinpoint.Repo)
  ...
  """
  def valid_password?(%Pinpoint.Accounts.User{hashed_password: hashed_password}, password)
